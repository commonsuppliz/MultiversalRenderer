    ...
    public sealed class CHtmlMultiversalWindow : IMultiversalWindow, IMultiversalWindow_HTML5_Property_Interface, IDisposable
    {
        ...
        public void initializeMultiversalScopes(bool isCreateStandardObjects)
        {
            ...
            for (int i = 0; i < iTypeCont; i++)
            {
                ...
                if (iscope.___isDefaultMultiversalProcessor() == true)
                {
                ...
                string[] strCallingNames = iscope.___getMultiversalInvokeScriptNames();
                iscope.___setMutilversalWindowType(this.___multiversalWindowType);
                ...
                {
                    iscope.___initScriptEngine();
                }
                this.___MultiversalScopeList[iscope.___getMultivasalScopeName()] = iscope;
            }
        }
        ...
        public IMultiversalScriptProcessor getMultiversalScriptProcessorByScriptType(string ___type)
        {
            ...
            if (__scope != null)
            {
                return __scope.___getMultiversalScriptProcessor();
            }
            return null;
        }
        ...
        public void execute(string strScript, string ___languate)
        {
            ...
            {
                ___processor = this.___MultiversalScriptScopeDefaultLanguage.___getMultiversalScriptProcessor(); ;
            ...
            if (___weakref != null)
            {
                ...
                ___processor = iscope.___getMultiversalScriptProcessor();
            }
            ProcessorObtained:
            if (___processor != null)
            {
                if (___processor.multiversalscope.___isInitCompleted() == false)
                {
                    ___processor.multiversalscope.___initScriptEngine();
                }
