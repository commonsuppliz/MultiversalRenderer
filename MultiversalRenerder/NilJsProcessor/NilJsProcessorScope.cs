...
#pragma warning disable 618
    public class NilJsScope : IMultiversalScope
    {
        ...
        public IMultiversalScope ___constructorMultiversalScope(IMultiversalWindow multi)
        {
            multiwindow = multi;
            return this;
        }
        ...
        {
            return ___getClassNameString;
        }
        public void ___createStandardObjects()
        {
            ...
            //this.defineProperty("confirm", new BaseFunctionDelegate("confirm", new BaseFunctionDelegate.Delegate4Object(this.___Multiversal.confirm)), ScriptableObject.PERMANENT);
            ...
            //this.defineProperty("getSelection", new BaseFunctionDelegate("getSelection", new BaseFunctionDelegate.Delegate4Object(this.___Multiversal.getSelection)), ScriptableObject.PERMANENT);
